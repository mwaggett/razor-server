...
test_name "C569 Create only one Policy with same identity 'before' configuration parameter"
step "https://testrail.ops.puppetlabs.net/index.php?/cases/view/569"
