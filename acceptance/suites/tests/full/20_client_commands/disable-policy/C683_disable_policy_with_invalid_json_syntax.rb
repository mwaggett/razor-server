...
test_name "Disable policy with Invalid Syntax for JSON File"
step "https://testrail.ops.puppetlabs.net/index.php?/cases/view/683"
...
razor agents, 'disable-policy', json, exit: 1 do |agent, text|
