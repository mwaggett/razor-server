...
test_name "C560 Create Policy with invalid hostname configuration parameter"
step "https://testrail.ops.puppetlabs.net/index.php?/cases/view/560"
...
razor agents, 'create-policy', json, exit: 1 do |agent, text|
  ...
  assert_match /hostname should be a string, but was actually a boolean/, text
end
