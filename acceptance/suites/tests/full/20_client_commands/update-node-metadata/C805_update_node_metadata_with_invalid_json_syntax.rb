...
test_name "Update node metadata with invalid JSON syntax with Invalid Syntax for JSON File"
step "https://testrail.ops.puppetlabs.net/index.php?/cases/view/805"

reset_database
step 'Create the (deliberately invalid) JSON file containing the arguments'
json = '{
  "node" => "puppet-test-node",
  "key" => "abc",
  "value" => "def"
...
razor agents, 'update-node-metadata', json, exit: 1 do |agent, text|
