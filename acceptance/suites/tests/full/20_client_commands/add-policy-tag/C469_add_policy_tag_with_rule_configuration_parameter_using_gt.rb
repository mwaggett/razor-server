...
test_name 'Add policy tag with rule configuration parameter using "gt"'
step 'https://testrail.ops.puppetlabs.net/index.php?/cases/view/469'
...
razor agents, "add-policy-tag --name #{policy_name} --tag #{tag_name} --rule " + '\'["gt", 2, 1]\'' do |agent|
