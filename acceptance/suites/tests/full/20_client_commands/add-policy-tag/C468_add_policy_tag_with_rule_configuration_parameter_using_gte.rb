...
test_name 'Add policy tag with rule configuration parameter using "gte"'
step 'https://testrail.ops.puppetlabs.net/index.php?/cases/view/468'
...
razor agents, "add-policy-tag --name #{policy_name} --tag #{tag_name} --rule " + '\'["gte", 1, 1]\'' do |agent|
