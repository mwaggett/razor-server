...
test_name 'Add policy tag with rule configuration parameter using "or"'
step 'https://testrail.ops.puppetlabs.net/index.php?/cases/view/460'
...
razor agents, "add-policy-tag --name #{policy_name} --tag #{tag_name} --rule " + '\'["or", true, true]\'' do |agent|
