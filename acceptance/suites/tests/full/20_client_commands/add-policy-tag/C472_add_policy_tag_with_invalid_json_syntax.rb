...
test_name "Add policy tag with Invalid Syntax for JSON File"
step "https://testrail.ops.puppetlabs.net/index.php?/cases/view/472"
...
razor agents, 'add-policy-tag', json, exit: 1 do |agent, text|
