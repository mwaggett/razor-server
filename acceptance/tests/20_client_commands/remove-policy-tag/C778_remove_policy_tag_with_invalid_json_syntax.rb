...
test_name "Remove policy tag with invalid JSON syntax with Invalid Syntax for JSON File"
step "https://testrail.ops.puppetlabs.net/index.php?/cases/view/778"
...
razor agents, 'remove-policy-tag', json, exit: 1 do |agent, text|
