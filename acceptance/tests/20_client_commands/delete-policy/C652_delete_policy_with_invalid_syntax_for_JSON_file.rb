...
test_name "Delete Policy with Invalid Syntax for JSON File"
step "https://testrail.ops.puppetlabs.net/index.php?/cases/view/652"
...
razor agents, 'delete-policy', json, exit: 1 do |agent, text|
