...
test_name 'Add policy tag with rule configuration parameter using "and"'
step 'https://testrail.ops.puppetlabs.net/index.php?/cases/view/459'
...
razor agents, "add-policy-tag --name #{policy_name} --tag #{tag_name} --rule " + '\'["and", true, false]\'' do |agent|
