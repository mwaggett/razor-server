...
test_name 'Add policy tag with rule configuration parameter using "metadata"'
step 'https://testrail.ops.puppetlabs.net/index.php?/cases/view/463'
...
razor agents, "add-policy-tag --name #{policy_name} --tag #{tag_name} --rule " + '\'["=", ["metadata", "key"], "value"]\'' do |agent|
