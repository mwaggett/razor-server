...
test_name 'Add policy tag with rule configuration parameter using "eq"'
step 'https://testrail.ops.puppetlabs.net/index.php?/cases/view/464'
...
razor agents, "add-policy-tag --name #{policy_name} --tag #{tag_name} --rule " + '\'["eq", true, true]\'' do |agent|
