...
test_name 'Add policy tag with rule configuration parameter using "not"'
step 'https://testrail.ops.puppetlabs.net/index.php?/cases/view/461'
...
razor agents, "add-policy-tag --name #{policy_name} --tag #{tag_name} --rule " + '\'["not", true]\'' do |agent|
