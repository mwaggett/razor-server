...
test_name 'Create task with long name'
step 'https://testrail.ops.puppetlabs.net/index.php?/cases/view/582'
...
razor agents, 'create-task', json do |agent|
  ...
  text = on(agent, "razor -u http://#{agent}:8080/api tasks #{name}").output
