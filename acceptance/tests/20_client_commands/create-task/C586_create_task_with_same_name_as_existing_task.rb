...
test_name 'Create Task with Same Name as Existing Task'
step 'https://testrail.ops.puppetlabs.net/index.php?/cases/view/586'
...
razor agents, 'create-task', json do |agent|
  ...
  text = on(agent, "razor -u https://#{agent}:8151/api tasks new-task").output
  assert_match /new-task/, text
end
json = {
    "name" => "new-task",
    "os" => "Not the same os",
