...
test_name "C572 Create Policy with blank 'after' configuration parameter"
step "https://testrail.ops.puppetlabs.net/index.php?/cases/view/572"
...
razor agents, 'create-policy', json, exit: 1 do |agent, text|
  ...
  assert_match /after must be the name of an existing policy, but is ''/, text
end
