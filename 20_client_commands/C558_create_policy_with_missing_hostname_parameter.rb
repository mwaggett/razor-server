...
test_name "C558 Create Policy with missing hostname configuration parameter"
step "https://testrail.ops.puppetlabs.net/index.php?/cases/view/558"
...
razor agents, 'create-policy', json, exit: 1 do |agent, text|
  ...
  assert_match /hostname is a required attribute, but it is not present/, text
end
