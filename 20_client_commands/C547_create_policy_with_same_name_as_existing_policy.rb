...
test_name "C547 Create Policy"
step "https://testrail.ops.puppetlabs.net/index.php?/cases/view/547"
...
json = {
  ...
  "root-password" => "squirrel",
  "tags"          => ["small"]
}

razor agents, 'create-policy', json, exit: 1 do |agent, text|
  assert_match /404 Resource Not Found/, text
  assert_match /repo must be the name of an existing repo, but is 'centos-6.5'/, text
end
